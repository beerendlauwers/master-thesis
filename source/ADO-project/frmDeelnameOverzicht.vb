...
#Region "OnComboBoxChanged Event"
                ...
                For r = i + 1 To (geldigenamen.Length() - 1)
                    ...
                    While r < geldigenamen.Length() - 1
                        ...
                        If (geldigenamen(r) = String.Empty) Then
                            r = r + 1
                        Else
                            'Anders nemen we de naam van de array en steken ze in 'checknaam2'
