        ...
        <tr valign=top>
                ...
                <table>
                    <tr>
                        <td colspan="2" align="center">
                            <asp:Label ID="lblFiliaalToevoegen" runat="server" Text="Filiaal Toevoegen"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <td>
                <table>
                    <tr>
                        <td colspan="2" align="center">
                            <asp:Label ID="lblFiliaalVerwijderen" runat="server" Text="Filiaal Verwijderen"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
