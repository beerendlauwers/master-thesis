...
Public Class ControleBLL
    ...
    Public Function GetControleByControleID(ByVal controleID As Integer) As Onderhoud.tblControleRow
        Try
            Return _controledal.GetControleByControleID(controleID)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Public Function GetAllOudeControlesByAutoID(ByVal autoID As Integer) As Onderhoud.tblControleDataTable
        Try
            Return _controledal.GetAllOudeControlesByAutoID(autoID)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Public Function InsertGeplandeControle(ByRef c As Onderhoud.tblControleRow, ByRef omschrijving As String) As Boolean
        Try
    ...
    Private Function InsertNieuweControle(ByRef c As Onderhoud.tblControleRow) As Integer
        Try
    ...
    Private Function InsertNieuwNazicht(ByRef c As Onderhoud.tblControleRow) As Integer
        Try
            Return _controledal.InsertNieuwNazicht(c)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Public Function InsertNazicht(ByRef c As Onderhoud.tblControleRow) As Boolean
        Try
            Dim controleID As Integer = InsertNieuwNazicht(c)
