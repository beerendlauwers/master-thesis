...
{-# LINE 10 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG.hs" #-}

{-# LINE 2 "src\\CCO\\SystemF\\AG/Printing.ag" #-}

import CCO.Printing
{-# LINE 15 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG.hs" #-}
{-# LINE 10 "src\\CCO\\SystemF\\AG/Base.ag" #-}

type TyVar = String    -- ^ Type of type variables. 
type Var   = String    -- ^ Type of variables.
{-# LINE 20 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG.hs" #-}

{-# LINE 49 "src\\CCO\\SystemF\\AG/Printing.ag" #-}

-- | Type of precedence levels.
type Prec = Int
{-# LINE 26 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG.hs" #-}
...
ppInfixML ctx (op, prec) l r = modifier $ l >#< ppOp >-< r
  where
    ...
    ppOp         = text op
{-# LINE 55 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG.hs" #-}
...
{-# LINE 66 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG.hs" #-}
-- Tm ----------------------------------------------------------
data Tm = App (Tm) (Tm)
        | Lam (Var) (Ty) (Tm)
        | TyApp (Tm) (Ty)
         ...
         (let _lhsOppML :: Doc
              ...
              _ppSL =
                  ({-# LINE 29 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   ...
                   {-# LINE 113 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppML =
                  ({-# LINE 37 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   _ppSL     >^<
                   ppInfixML _lhsIprec ("", 10) _t1IppML _t2IppML
                   {-# LINE 119 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _t1Oprec =
                  ({-# LINE 65 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   10
                   {-# LINE 124 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _t2Oprec =
                  ({-# LINE 66 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   11
                   {-# LINE 129 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppSL =
                  ({-# LINE 11 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   _ppSL
                   {-# LINE 134 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              ( _t1IppML,_t1IppSL) =
                  t1_ _t1Oprec
              ( _t2IppML,_t2IppSL) =
              ...
              _ppSL =
                  ({-# LINE 27 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   ppBinderSL "\\" (text x_ >#< text ":" >#< _tyIppSL)
                     _t1IppSL
                   {-# LINE 159 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppML =
                  ({-# LINE 34 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   ...
                   ppBinderML "\\" (text x_ >#< text ":" >#< _tyIppML)
                     _t1IppML
                   {-# LINE 166 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _tyOprec =
                  ({-# LINE 63 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   0
                   {-# LINE 171 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _t1Oprec =
                  ({-# LINE 64 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   0
                   {-# LINE 176 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppSL =
                  ({-# LINE 11 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   _ppSL
                   {-# LINE 181 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              ( _tyIppML,_tyIppSL) =
                  ty_ _tyOprec
              ( _t1IppML,_t1IppSL) =
         ...
         (let _lhsOppML :: Doc
              ...
              _ppSL =
                  ({-# LINE 31 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   ...
                   {-# LINE 204 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppML =
                  ({-# LINE 41 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   ...
                   {-# LINE 211 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _t1Oprec =
                  ({-# LINE 68 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   9
                   {-# LINE 216 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _tyOprec =
                  ({-# LINE 69 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   0
                   {-# LINE 221 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppSL =
                  ({-# LINE 11 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   _ppSL
                   {-# LINE 226 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              ( _t1IppML,_t1IppSL) =
                  t1_ _t1Oprec
              ( _tyIppML,_tyIppSL) =
         ...
         (let _lhsOppML :: Doc
              ...
              _ppSL =
                  ({-# LINE 30 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   ...
                   {-# LINE 246 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppML =
                  ({-# LINE 39 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   _ppSL     >^<
                   ppBinderML "/\\" (text a_) _t1IppML
                   {-# LINE 252 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _t1Oprec =
                  ({-# LINE 67 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   0
                   {-# LINE 257 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppSL =
                  ({-# LINE 11 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   _ppSL
                   {-# LINE 262 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              ( _t1IppML,_t1IppSL) =
                  t1_ _t1Oprec
          in  ( _lhsOppML,_lhsOppSL)))
         ...
         (let _lhsOppML :: Doc
              ...
              _ppSL =
                  ({-# LINE 26 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   text x_
                   {-# LINE 276 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppML =
                  ({-# LINE 33 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   _ppSL
                   {-# LINE 281 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppSL =
                  ({-# LINE 11 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   _ppSL
                   {-# LINE 286 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
          in  ( _lhsOppML,_lhsOppSL)))
-- Ty ----------------------------------------------------------
data Ty = Arr (Ty) (Ty)
         ...
         (let _lhsOppML :: Doc
              ...
              _ppSL =
                  ({-# LINE 16 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   ...
                   {-# LINE 330 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppML =
                  ({-# LINE 20 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   _ppSL     >^<
                   ppInfixML _lhsIprec ("->", 0) _ty1IppML _ty2IppML
                   {-# LINE 336 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _ty1Oprec =
                  ({-# LINE 58 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   1
                   {-# LINE 341 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _ty2Oprec =
                  ({-# LINE 59 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   0
                   {-# LINE 346 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppSL =
                  ({-# LINE 11 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   _ppSL
                   {-# LINE 351 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              ( _ty1IppML,_ty1IppSL) =
                  ty1_ _ty1Oprec
              ( _ty2IppML,_ty2IppSL) =
         ...
         (let _lhsOppML :: Doc
              ...
              _ppSL =
                  ({-# LINE 17 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   ...
                   {-# LINE 371 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppML =
                  ({-# LINE 22 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   _ppSL     >^<
                   ppBinderML "forall " (text a_) _ty1IppML
                   {-# LINE 377 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _ty1Oprec =
                  ({-# LINE 60 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   0
                   {-# LINE 382 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppSL =
                  ({-# LINE 11 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   _ppSL
                   {-# LINE 387 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              ( _ty1IppML,_ty1IppSL) =
                  ty1_ _ty1Oprec
          in  ( _lhsOppML,_lhsOppSL)))
         ...
         (let _lhsOppML :: Doc
              ...
              _ppSL =
                  ({-# LINE 15 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   text a_
                   {-# LINE 401 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppML =
                  ({-# LINE 19 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   _ppSL
                   {-# LINE 406 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
              _lhsOppSL =
                  ({-# LINE 11 "src\\CCO\\SystemF\\AG/Printing.ag" #-}
                   _ppSL
                   {-# LINE 411 "dist\\build\\hm2systemf\\hm2systemf-tmp\\CCO\\SystemF\\AG" #-}
                   )
          in  ( _lhsOppML,_lhsOppSL)))